...
SELECT '苹果', '新鲜红富士苹果，营养丰富', 5.50, '食品饮料', 'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=200', 100
WHERE NOT EXISTS (SELECT 1 FROM products WHERE name = '苹果');

INSERT INTO products (name, description, price, category, image_url, stock_quantity) 
SELECT '牛奶', '优质纯牛奶，富含钙质', 12.80, '食品饮料', 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=200', 50
WHERE NOT EXISTS (SELECT 1 FROM products WHERE name = '牛奶');

INSERT INTO products (name, description, price, category, image_url, stock_quantity) 
SELECT '洗发水', '深层清洁去屑洗发水', 29.90, '个人护理', 'https://images.unsplash.com/photo-1561948955-5d3d4f7a3b3d?w=200', 30
WHERE NOT EXISTS (SELECT 1 FROM products WHERE name = '洗发水');

INSERT INTO products (name, description, price, category, image_url, stock_quantity) 
SELECT '洗衣液', '高效去污洗衣液', 25.00, '清洁用品', 'https://images.unsplash.com/photo-1561948955-5d3d4f7a3b3d?w=200', 40
WHERE NOT EXISTS (SELECT 1 FROM products WHERE name = '洗衣液');

INSERT INTO products (name, description, price, category, image_url, stock_quantity) 
SELECT '面包', '全麦营养面包', 8.50, '食品饮料', 'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=200', 20
WHERE NOT EXISTS (SELECT 1 FROM products WHERE name = '面包');
